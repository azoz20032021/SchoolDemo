...
export const Registrations: React.FC = () => {
    ...
    return (
        <div className="p-4 md:p-6 space-y-4">
            <div>
                <h2 className="text-xl font-black text-slate-900 tracking-tight">{t('طلبات التسجيل')}</h2>
                ...
                {TABS.map(({ key, label, icon: Icon }) => (
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-black whitespace-nowrap transition-colors ${
                            tab === key ? 'bg-brand-700 text-white shadow-lg shadow-brand-100' : 'bg-white text-slate-500 border border-slate-100'
                        }`}
                    >
                ...
                {loading ? (
                    ...
                    <div className="divide-y divide-slate-50">
                        {rows.map((row) => (
                            ...
                            >
                                <div className="w-11 h-11 bg-brand-50 text-brand-700 rounded-2xl flex items-center justify-center shrink-0">
                ...
                {viewing && (
                    <div className="space-y-5">
                        ...
                        <div className="grid md:grid-cols-2 gap-x-6">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-brand-700 uppercase tracking-widest mb-1 mt-4 md:mt-0">
                        ...
                        {isTeacherApplication ? (
                            <div>
                                <p className="text-[10px] font-black text-brand-700 uppercase tracking-widest mb-1">{t('المعلومات المهنية')}</p>
                            ...
                            <div>
                                <p className="text-[10px] font-black text-brand-700 uppercase tracking-widest mb-1">{t('المعلومات الدراسية')}</p>
