        ...
        <div ref={boxRef} className="relative">
            ...
            {selected ? (
                ...
                <div className="relative">
                    ...
                    />
                    {loading && (
                        <Loader2 className="w-4 h-4 text-brand-400 animate-spin absolute top-1/2 -translate-y-1/2 left-3.5" />
                    )}
                </div>
            )}
                        ...
                        <>
                            {matches.map((s) => (
                                <button
                                    ...
                                    type="button"
                                    onClick={() => pick(s)}
                                    className="w-full text-right px-4 py-2.5 hover:bg-brand-50 border-b border-slate-50 last:border-0 transition-colors"
                                >
