export type Role = 'admin' | 'teacher' | 'student' | 'assistant_admin' | 'guardian';
...
export interface UserData {
    ...
    /** The children a guardian account may look at. */
    student_ids?: string[];

    /** Opened with a temporary password; nothing works until it is replaced. */
