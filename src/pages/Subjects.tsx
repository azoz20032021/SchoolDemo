                        ...
                        {filteredGrades.map((g, i) => (
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    <div>
                                        <p className="text-[10px] font-bold text-brand-700 uppercase tracking-widest bg-brand-50 px-3 py-1 rounded-full w-fit">
            ...
            <div className="flex items-center justify-between mb-2">
                ...
                {(user.role === 'admin' || user.role === 'assistant_admin') && (
                    <button
                        ...
                        className="bg-brand-700 text-white p-3 rounded-2xl shadow-lg shadow-brand-200 hover:scale-105 active:scale-95 transition-all"
                    >
            ...
            <AnimatePresence>
                {showAddSubject && (
                    <motion.form
                        ...
                        className="bg-white p-6 rounded-[2rem] border border-brand-100 shadow-xl shadow-brand-50/50 space-y-4 overflow-hidden"
                    >
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-6 py-4 rounded-2xl border border-slate-100 bg-slate-50/50 outline-none focus:border-brand-400 focus:bg-white transition-all font-bold text-sm"
